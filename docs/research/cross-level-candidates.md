# Cross-Level Duplication Candidates

Analysis of items currently at a single pipeline level that have meaningful formulations at other levels.

## Items to duplicate

---

### Scene-Level Criteria to duplicate upward

---

### SC-003: Aggregate Consistency Across Length (currently: scene)
...
### SC-008: Audience Expectation Alignment (currently: scene)
...
### SC-026: Chapter/Scene Length Variation (currently: scene)

**Proposed additional levels:**
- **chapter_plan**: Whether the planned scenes within a chapter vary in intended weight/length to create pacing rhythm, rather than all being the same approximate scale.
- **novel_plan**: Whether chapters in the novel plan vary in planned scope and density to create macro-pacing rhythm.
...
### SC-028: Character Complexity Through Contradiction (currently: scene)
...
### SC-035: Character Self-Revelation (currently: scene)
...
### SC-039: Character-as-Theme (currently: scene)

**Proposed additional levels:**
- **chapter_plan**: Whether the character's planned journey across scenes embodies and investigates the chapter's thematic questions through dramatic action rather than exposition.
...
### SC-051: Curiosity Engine (Question Architecture) (currently: scene)
...
### SC-083: Emotional Continuity (currently: scene)
...
### SC-108: Flashback Integration Without Momentum Loss (currently: scene)
...
### SC-136: Macro-Pacing Variation (currently: scene)

**Proposed additional levels:**
- **chapter_plan**: Whether the chapter plan alternates scene intensity -- not every scene at the same dramatic pitch.
- **novel_plan**: Whether the novel plan alternates chapter intensity across acts, creating valleys and peaks rather than uniform tension.
...
### SC-154: Non-Default Narrative Choices (currently: scene)

**Proposed additional levels:**
- **chapter_plan**: Whether the chapter plan makes surprising structural choices -- unexpected scene orderings, unconventional POV selections, non-obvious entry/exit points.
...
### SC-194: Reaction Beat Pacing (currently: scene)

**Proposed additional levels:**
- **chapter_plan**: Whether the chapter plan includes reaction/processing scenes after major events, rather than jumping immediately to the next action scene.
...
### SC-264: Surprise and Misdirection (currently: scene)
...
### SC-279: Three-Level Stakes Architecture (currently: scene)

**Proposed additional levels:**
- **chapter_plan**: Whether the chapter plan operates simultaneously on public (plot), personal (character), and philosophical (theme) stakes across its scenes.
- **novel_plan**: Whether the novel plan establishes and develops all three levels of stakes across its arc.
...
### Scene-Level Sentinels to duplicate upward

---

### SS-039: All Scenes End with Clean Resolution (currently: scene)
...
**Proposed additional levels:**
- **chapter_plan**: Whether the first chapter's scene plan consists primarily of backstory delivery and character history rather than present-tense dramatic action.
...
### SS-066: Cosmetic Flaws Only (currently: scene)
...
### SS-124: Homogeneous Ensemble (currently: scene)
...
### SS-146: Missing Character Wound (currently: scene)

**Proposed additional levels:**
- **chapter_plan**: Whether the protagonist has an identifiable past trauma or formative injury that drives their planned behavior and arc across the chapter's scenes.
- **novel_plan**: Whether the protagonist in the novel plan has a psychological wound that explains their present behavior and provides the engine for their transformation arc.
- **ideation**: Whether the character concept includes a wound/trauma that will generate dramatic tension and arc potential.
...
**Proposed additional levels:**
- **chapter_plan**: Whether conflicts in the chapter plan are introduced and resolved within the same scene or adjacent scenes, never persisting across multiple scenes.
...
### SS-296: Sycophantic Resolution (currently: scene)

**Proposed additional levels:**
- **chapter_plan**: Whether the chapter plan resolves by validating every character's perspective with no genuine cost or loss.
- **novel_plan**: Whether the novel plan's ending validates all perspectives, avoids all judgment, and produces universal reconciliation without meaningful sacrifice.
...
**Proposed additional levels:**
- **chapter_plan**: Whether alien/fantasy species in the chapter plan exhibit only a single cultural trait, with every member encountered behaving identically.
- **novel_plan**: Whether the novel plan's non-human cultures are designed with internal diversity, or whether each is defined by a single characteristic.
...
### Chapter-Plan-Level Criteria to duplicate to other levels

---

### CC-020: Character Agency (currently: chapter_plan)

**Proposed additional levels:**
- **novel_plan**: Whether the novel plan shows the protagonist's choices driving the overall plot trajectory, rather than external events determining the story's direction.
- **ideation**: Whether the story concept is structured so that the protagonist's decisions are the primary engine of plot, not circumstance.
...
### CC-055: Dilemma Quality (currently: chapter_plan)
...
### CC-063: Ensemble Differentiation (currently: chapter_plan)
...
### CC-087: Ghost/Wound/Lie/Weakness Architecture (currently: chapter_plan)
...
### CC-104: Meaning Inseparable from Form (currently: chapter_plan)
...
### CC-210: Want/Need Tension (currently: chapter_plan)
...
### Chapter-Plan-Level Sentinels to duplicate to other levels

---

### CS-006: All Characters Agree on the Moral Position (currently: chapter_plan)
...
### CS-029: Emotional Architecture Collapse (currently: chapter_plan)
...
### CS-042: Generic/Platitudinous Theme (currently: chapter_plan)
...
### CS-052: Melodramatic Stakes Inflation (currently: chapter_plan)
...
### CS-091: Thematic Safety (Avoidance of Moral Discomfort) (currently: chapter_plan)
...
### Novel-Plan-Level Criteria to duplicate downward

---

### NC-003: Central Dramatic Question Clarity (currently: novel_plan)
...
### Novel-Plan-Level Sentinels to duplicate downward

---

### NS-005: Flat Narrative Arc (currently: novel_plan)
...
### NS-009: Homogeneously Positive Arc (currently: novel_plan)
...
### Ideation-Level Criteria to duplicate downward

---

### IC-001: "What If" Question Compellingness (currently: ideation)

**Proposed additional levels:**
- **novel_plan**: Whether the novel plan actually explores the implications of its "what if" question across the full arc, rather than using it as a setting conceit and then telling a conventional story.
- **chapter_plan**: Whether individual chapters advance the exploration of the central "what if" question through their scenes.
...
### Ideation-Level Sentinels to duplicate downward

---

### IS-001: Opening Paragraph Uses Stock Attention-Grabbing Formula (currently: ideation)

**Proposed additional levels:**
- **scene**: Whether the opening paragraph of the actual prose uses a formulaic attention-grabbing construction ("Have you ever wondered...", "What if I told you...", "It was a dark and stormy night...").
...
### Multi-Level Items with missing levels

---

### ML-001: Abstraction Trap Sentinel (currently: ideation, scene)
...
### ML-005: Conceptual Originality (currently: ideation, scene)
...
### ML-014: Genre-Flavored Non-Genre Story (currently: novel_plan, scene)
...
### ML-041: Specificity and Concrete Detail (currently: ideation, scene)

**Proposed additional levels:**
- **chapter_plan**: Whether scene descriptions in the chapter plan use specific, concrete situations rather than vague summaries.
- **novel_plan**: Whether chapter summaries in the novel plan describe specific dramatic situations rather than abstract narrative movements.

---

### ML-046: Suspension of Disbelief (currently: chapter_plan, ideation)

**Proposed additional levels:**
- **scene**: Whether the prose maintains the reader's voluntary acceptance of fictional premises through sufficient human interest, internal consistency, and specific detail.
- **novel_plan**: Whether the novel plan structures its speculative elements to build and maintain reader belief across the full arc.

Note: ML-047 covers "Suspension of Disbelief Maintenance" at chapter_plan and ideation. SC-100 covers "Fictive Dream Continuity" at scene. These are conceptually related and should potentially be unified.

---

### ML-048: Thematic Premise as Dramatic Argument (currently: ideation, novel_plan)

**Proposed additional levels:**
- **chapter_plan**: Whether individual chapters advance the thematic argument through specific dramatic events and character choices, rather than merely restating it.

---

### ML-050: Thematic Unity Across Story Elements (currently: novel_plan, scene)

**Proposed additional levels:**
- **chapter_plan**: Whether all major elements within each chapter (scene selection, character focus, setting choices) work together to express the chapter's contribution to the overall theme.
- **ideation**: Whether the story concept integrates its thematic content into its premise, character design, and world concept rather than treating theme as a separate overlay.

---

### ML-061: Moral and Thematic Complexity (currently: ideation, scene, chapter_plan)

**Proposed additional levels:**
- **novel_plan**: Whether the novel plan as a whole presents genuine moral complexity -- competing valid perspectives, ambiguous situations, unresolved tensions -- across its full arc.

---

---

## Items reviewed and NOT duplicated

The following categories of items were reviewed and determined to not have meaningful formulations at additional levels.

### Prose-mechanics items (scene-only)

These items require actual prose text to evaluate and have no meaningful plan-level formulation:

SC-002 (Adverb Control), SC-005 (Apostrophe Correctness), SC-025 (Capitalization Consistency), SC-042 (Comma Splice Management), SC-044 (Concision and Filler Word Control), SC-046 (Consistency of Style Choices), SC-048 (Correct Speaker Tag Verbs), SC-053 (Dangling Modifiers), SC-062 (Dialogue Punctuation), SC-069 (Diction Precision), SC-075 (Echo Word Avoidance), SC-078 (Ellipsis Formatting), SC-079 (Em Dash/En Dash/Hyphen Distinction), SC-104 (Filter Word Control), SC-117 (Grammar Correctness), SC-121 (Hyphenation Consistency), SC-133 (Italics Usage), SC-157 (Number Formatting), SC-173 (Participial Phrase Accuracy), SC-174 (Passive Voice Control), SC-189 (Punctuation Accuracy), SC-192 (Quotation Marks), SC-195 (Readability of Complex Sentences), SC-206 (Said Bookism Avoidance), SC-209 (Scene Break Formatting), SC-230 (Sentence Clarity), SC-231 (Sentence Fragment Control), SC-250 (Spelling/Typo Freedom), SC-255 (Subject-Verb Agreement), SC-271 (Tense Consistency), SC-296 (Widows and Orphans Control), SC-298 (Word Choice Precision).

### Voice and style items (scene-only)

These require actual prose to evaluate -- voice is a property of the writing, not the plan:

SC-012 (Authorial Voice Distinctiveness), SC-016 (Authorial Voice and Stylistic Identity), SC-040/SC-041 (Cliche Avoidance at sentence level), SC-054/SC-055 (Defamiliarization), SC-070 (Distinctive Voice), SC-077 (Economy of Language), SC-093 (Expectation-Silence-Surprise Pattern), SC-185 (Prose Stress Pattern Awareness), SC-186 (Prose Transparency vs. Opacity), SC-200 (Register Appropriateness), SC-226 (Sensory Engagement), SC-232/SC-233/SC-234/SC-235 (Sentence Variety/Rhythm), SC-247 (Sound and Euphony), SC-254 (Style-Content Alignment), SC-268 (Syntactic Sophistication), SC-283 (Tonal Control), SC-289 (Verb Strength), SC-293 (Voice Layering).

### POV-specific technical items (scene-only)

These evaluate POV execution in prose, which isn't evaluatable at plan level:

SC-009/SC-010 (Author Intrusion), SC-011 (Author/Narrator Voice Separation), SC-032 (Character Interiority Quality), SC-056 (Description Filtered Through POV), SC-072 (Dramatic Irony Through POV), SC-092 (Epistolary Narration Craft), SC-105/SC-106 (Filter Word Management/Control), SC-107 (First-Person Self-Description), SC-110 (Focalization Clarity), SC-112/SC-113 (Free Indirect Discourse), SC-119 (Head-Hopping Control), SC-128 (Information Management Through POV), SC-129 (Interior Monologue Integration), SC-130 (Interiority Balance), SC-148 (Narrative Depth Variation), SC-150 (Narrative Stance/Tone Consistency), SC-153 (Narrator-Narratee Relationship), SC-160 (Omniscient Narrator Voice), SC-163/SC-164/SC-165 (POV Consistency variants), SC-166/SC-167 (POV Information/Knowledge Discipline), SC-169 (POV Transition Craft), SC-188 (Psychic Distance Control), SC-204 (Retrospective Narrator Distance), SC-222 (Second Person Narration), SC-242 (Showing vs Telling Through POV), SC-252 (Stream of Consciousness Craft), SC-287 (Unreliable Narrator Craft), SC-291 (Vocabulary Alignment with POV).

However: SC-116 (Genre-Appropriate POV Convention), SC-118 (Multi-POV Management), SC-162 (POV Character Selection Per Scene), and SC-168 (POV Switch Pacing) are plan-level concerns already covered by CC-108 (Multi-POV Management) and CC-118 (POV Selection Appropriateness).

### Dialogue-specific technical items (scene-only)

These evaluate the craft of actual dialogue writing:

SC-034 (Character Name Overuse), SC-059 (Dialogue Compression), SC-060 (Dialogue Exposition Naturalness), SC-061 (Dialogue Pacing), SC-063 (Dialogue Purpose), SC-064 (Dialogue Rhythm), SC-065/SC-066 (Dialogue Tag Craft), SC-067 (Dialogue-Action Integration), SC-068 (Dialogue-to-Narration Balance), SC-080 (Emotion Through Speech Patterns), SC-094 (Exposition Handling in Dialogue), SC-131 (Internal Monologue-Dialogue Integration), SC-144 (Monologue Management), SC-147 (Multi-Character Conversation), SC-155 (Non-Linear Exchange Patterns), SC-161 (On-the-Nose Dialogue Avoidance), SC-181 (Power Dynamics in Conversation), SC-201 (Register and Sociolect Accuracy), SC-246 (Silence and Non-Response as Tools).

### Description-specific craft items (scene-only)

These evaluate the quality of actual descriptive prose:

SC-057 (Description Pacing), SC-058 (Description as Characterization), SC-076 (Economy of Description), SC-097 (Extended Metaphor Craft), SC-101/SC-102/SC-103 (Figurative Language), SC-114 (Freshness of Figurative Language), SC-122 (Imagery-Clarity Balance), SC-137 (Maximalist Density), SC-158 (Objective Correlative), SC-159 (Objective Correlative in POV), SC-171 (Paragraph Length Variation), SC-172 (Paragraph Structure), SC-175 (Pathetic Fallacy Control), SC-177 (Personification Quality), SC-184 (Prose Rhythm in Description), SC-191 (Purple Prose vs. Purposeful Lushness), SC-207 (Scene Anchoring), SC-224/SC-225/SC-227/SC-228/SC-229 (Sensory detail variants), SC-237 (Setting as Active Element), SC-240 (Show vs. Tell in Description), SC-245 (Significant Detail Selection), SC-253 (Strong Nouns Over Adjective Padding), SC-267 (Synesthesia), SC-270 (Temporal Specificity), SC-299 (Word-Level Precision).

### Scene-internal structure items (scene-only)

These evaluate beat-level structure within individual scenes:

SC-178 (Physical Grounding and Blocking), SC-208 (Scene Beat Rhythm), SC-210 (Scene Causality Intra-Scene), SC-211 (Scene Emotional Arc), SC-213 (Scene Internal Pacing Curve).

### Scene-level sentinels targeting specific prose patterns

The vast majority of scene-level sentinels (SS-001 through SS-328) detect specific prose patterns, word choices, syntactic constructions, or formatting artifacts that can only be identified in actual written text. These include all AI-vocabulary sentinels, all punctuation/formatting sentinels, all "construction X detected" sentinels, and all prose-rhythm/statistical sentinels. None of these have meaningful plan-level formulations.

### Consistency-tracking items already at appropriate levels

SC-033 (Character Knowledge Tracking), SC-043 (Commonsense Physical Plausibility), SC-099 (Factual Detail Consistency), SC-123 (In-Scene Object Continuity), SC-132 (Internal Rule Consistency), SC-179 (Plot Armor), SC-203 (Retcon Avoidance), SC-248 (Spatial Logic), SC-282 (Timeline Coherence), SC-300 (Worldbuilding Implication Consistency) -- these consistency items operate at the scene level on prose-level details. The plan-level equivalents are already covered by CC-096 (Internal Consistency), CC-015 (Causal Chain Integrity), CC-200 (Travel Time Consistency), ML-018 (Internal Consistency of World Rules), etc.

### Genre-specific items at appropriate levels

The extensive genre-specific items at chapter_plan level (CC-001, CC-029, CC-044 through CC-049, CC-070, CC-072, CC-080 through CC-085, CC-088, CC-100, CC-102, CC-109, CC-122, CC-130, CC-134, CC-143, CC-144, CC-167, CC-182, CC-198, CC-201, CC-202, CC-208, CC-209, CC-213) are appropriately placed -- genre conventions are evaluated at the structural level. Their novel_plan equivalents are already covered by ML-013 (Genre Contract Fulfillment), ML-024 (Obligatory Scene Delivery), NC-013/NC-014 (Genre Contract), and various novel-plan genre sentinels.

### Chapter-plan structural items already comprehensive

CC-006 (Anti-Episodic Integration), CC-007 (Anticipation Construction), CC-016 (Central Conflict Clarity), CC-017 (Chapter Architecture), CC-030 (Commensurate Cause and Effect), CC-032 (Conflict Escalation Variety), CC-036 (Conflict Resolution Earnedness), CC-037 (Conflict Resolution Promise), CC-041 (Consequence Persistence), CC-043 (Contrivance Avoidance), CC-048 (Cost of Victory), CC-053 (De-escalation Avoidance), CC-054 (Deus Ex Machina Avoidance), CC-057 (Dual-Level Causal Logic), CC-073 (Five Commandments), CC-092 (Idiot Plot), CC-099 (Irreversibility), CC-110 (Narrative Momentum), CC-112 (Nonlinear Structure Integrity), CC-121 (Pixar Causal Spine), CC-125 (Progressive Complications), CC-135 (Red Herring vs Broken Promise), CC-138 (Resolution Quality), CC-140 (Reversal and Twist Quality), CC-185 (But/Therefore Test), CC-203/CC-204 (Try-Fail Cycles) -- these are structural analysis items that operate at the chapter-plan level on scene-to-scene relationships. Their novel-plan equivalents are largely covered by existing items (NC-002, NC-017, etc.), and they don't have meaningful scene-level (prose) formulations because they require seeing multiple scenes in relationship.

### Worldbuilding items already at appropriate levels

CC-008, CC-031, CC-050, CC-052, CC-060, CC-064, CC-086, CC-089, CC-101, CC-103, CC-119, CC-136, CC-163, CC-164, CC-168, CC-173, CC-181, CC-186, CC-200, CC-211, CC-212, CC-214, CC-215 -- worldbuilding criteria are correctly placed at chapter_plan level where the world's structure can be evaluated. Their scene-level evaluation is already covered by SC items (SC-050, SC-223, SC-229, SC-300, SC-301, etc.), and novel-plan level is covered by NC items and ML-018.
